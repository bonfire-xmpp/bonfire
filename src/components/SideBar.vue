<template>
  <div class="sidebar bg-grey-100 flex flex-col">
    <header-bar/>
...
import SelfBar from "@/components/SelfBar";
import HeaderBar from "@/components/HeaderBar";
import RosterList from "@/components/Roster/RosterList";

export default {
  components: {AccordionItem, SelfBar, HeaderBar, RosterList},
  data() {
    return {
      expanded: 0,
      menu: false,
