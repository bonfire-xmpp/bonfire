<template>
  <div class="input flex rounded">
    <button class="l rounded-l flex justify-center items-center" @click="dvalue--" ><span class="flex-grow">&ndash;</span></button>
    <input ref="input" class="px-2" :min="min" :max="max" type="number" v-model.number="dvalue">
    <button class="r rounded-r flex justify-center items-center" @click="dvalue++"><span class="flex-grow">+</span></button>
  </div>
</template>
